...
const HousingEdit = (props) => {
    ...
    const onFormSubmit = (e) => {
        ...
        props.onEditProduct(props.housing.id, name, category, hostId, numRooms);
       ...
       <div className="row mt-5">
            <div className="col-md-5">
               ...
               if(props.housing.category !== undefined && props.housing.category === term){
                    return  <option  value={props.housing.category} selected={props.housing.category === term} >{props.housing.category}</option>
                }
                  else{
                        ...
                        <select name="hostId" className="form-control" onChange={handleChange} > 
                            {props.hosts.map((term) =>{
                              if(props.housing.host !== undefined &&
                                ...
                                return <option selected={props.housing.host.id} value={term.id}>{term.name}</option>
